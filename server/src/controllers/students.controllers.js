...
import { addStudent, getStudentsByBatchCode } from "../repository/students.repository.js";

export const registerStudent = async (req, res) => {
    const { name, email, password, phone, gender, batchCode, rollNumber } = req.body;
  if (!name || !email || !password || !phone || !gender || !batchCode || !rollNumber) {
